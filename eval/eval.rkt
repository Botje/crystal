...
(set! *global-env*
      (list
       ...
       (new-binding 'car car)
       (new-binding 'cdr cdr)
       (new-binding 'caar caar)
       (new-binding 'cadr cadr)
       (new-binding 'cdar cdar)
       (new-binding 'cddr cddr)
       (new-binding 'caaar caaar)
       (new-binding 'caadr caadr)
       (new-binding 'cadar cadar)
       (new-binding 'caddr caddr)
       (new-binding 'cdaar cdaar)
       (new-binding 'cdadr cdadr)
       (new-binding 'cddar cddar)
       (new-binding 'cdddr cdddr)
       (new-binding 'caaaar caaaar)
       (new-binding 'caaadr caaadr)
       (new-binding 'caadar caadar)
       (new-binding 'caaddr caaddr)
       (new-binding 'cadaar cadaar)
       (new-binding 'cadadr cadadr)
       (new-binding 'caddar caddar)
       (new-binding 'cadddr cadddr)
       (new-binding 'cdaaar cdaaar)
       (new-binding 'cdaadr cdaadr)
       (new-binding 'cdadar cdadar)
       (new-binding 'cdaddr cdaddr)
       (new-binding 'cddaar cddaar)
       (new-binding 'cddadr cddadr)
       (new-binding 'cdddar cdddar)
       (new-binding 'cddddr cddddr)
       ))
