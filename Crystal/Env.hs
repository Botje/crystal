...
main_env = M.fromListWith or [
    ...
    "append"        --> TFun [1..2] emptyEffect . require [(TList,1), (TList,2)] TList,
    "apply"         --> TFun [1..2] emptyEffect . require [] TAny, -- todo function
    "assoc"         --> TFun [1..2] emptyEffect . require [(TList,2)] (Tor [TPair, TBool]),
    "assq"          --> TFun [1..2] emptyEffect . require [(TList,2)] (Tor [TPair, TBool]),
    "assv"          --> TFun [1..2] emptyEffect . require [(TList,2)] (Tor [TPair, TBool]),
    ...
    "car"           --> TFun [1..1] emptyEffect . require [(TList,1)] TAny,
    ...
    "cdr"           --> TFun [1..1] emptyEffect . require [(TList,1)] TList,
    ...
    "cons"          --> TFun [1..2] emptyEffect . require [(TList,2)] TList,
    ...
    "for-each"      --> TFun [1..2] emptyEffect . require [(TFun [3] emptyEffect TAny,1), (TList,2)] TVoid,
    ...
    "length"        --> TFun [1..1] emptyEffect . require [(TList,1)] TInt,
    "list"          --> makeVarFun "list" (\args -> require [] TList),
    "list?"         --> TFun [1..1] emptyEffect . require [] TBool,
    "list->vector"  --> TFun [1..1] emptyEffect . require [(TList,1)] TVec,
    "list-ref"      --> TFun [1..2] emptyEffect . require [(TList,1), (TInt,2)] TAny,
    ...
    "map"           --> TFun [1..2] emptyEffect . require [(TFun [3] emptyEffect TAny,1), (TList,2)] TList,
    "max"           --> TFun [1..2] emptyEffect . require [(TInt,1), (TInt,2)] TBool,
    "member"        --> TFun [1..2] emptyEffect . require [(TList, 2)] (Tor [TPair, TBool]),
    "memq"          --> TFun [1..2] emptyEffect . require [(TList, 2)] (Tor [TPair, TBool]),
    "memv"          --> TFun [1..2] emptyEffect . require [(TList, 2)] (Tor [TPair, TBool]),
    ...
    "reverse"       --> TFun [1..1] emptyEffect . require [(TList,1)] TList,
    ...
    "string->list"     --> TFun [1..1] emptyEffect . require [(TString,1)] TList,
    ...
    "vector->list"  --> TFun [1..1] emptyEffect . require [(TVec,1)] TList,
